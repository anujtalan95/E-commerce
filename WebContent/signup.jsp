...
#login-form{width:350px; background:#FFF; margin:50px auto; background:#f8f8f8; overflow:hidden; border-radius:7px; position: relative; top: 80px;}
...
<body background="images/bg-header-1.jpg">
...
<ul class="ul-list">
<li><input type="email" required class="input" placeholder="Your Email" name="email"/><span class="icon"><i class="fa fa-user"></i></span></li>
<li><input type="password" required class="input" placeholder="Password" name="pwd"/><span class="icon"><i class="fa fa-lock"></i></span></li>
...
<ul class="ul-list">
<li><input type="text" required class="input" placeholder="Your Name" name="name"/><span class="icon"><i class="fa fa-user"></i></span></li>
<li><input type="email" required class="input" placeholder="Your Email" name="email"/><span class="icon"><i class="fa fa-user"></i></span></li>
<li><input type="password" required class="input" placeholder="Password" name="pwd"/><span class="icon"><i class="fa fa-lock"></i></span></li>
